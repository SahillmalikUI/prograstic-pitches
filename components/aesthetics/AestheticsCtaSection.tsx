...
import { ArrowRight, Terminal, CheckCircle2, ShieldCheck, Zap, Sparkles, Heart } from "lucide-react";

interface AestheticsCtaSectionProps {
  onOpenScopeModal: () => void;
}

export function AestheticsCtaSection({ onOpenScopeModal }: AestheticsCtaSectionProps) {
  return (
    <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white text-slate-900">
      <div className="relative rounded-[40px] sm:rounded-[48px] bg-gradient-to-b from-[#FFFDF7] via-[#FEF3C7]/30 to-slate-50 border border-amber-200/90 p-8 sm:p-16 text-center space-y-8 shadow-xl overflow-hidden">
        {/* Soft Champagne Glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] bg-gradient-to-r from-amber-200/40 via-yellow-200/30 to-rose-100/40 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="space-y-4 max-w-3xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-amber-200 text-xs font-mono font-bold text-amber-900 shadow-sm">
            ...
            <span>15-MINUTE MEDSPA ARCHITECTURAL DISCOVERY</span>
          </div>

          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-950 font-display tracking-tight leading-tight">
            Elevate Your Clinic With Custom Clinical Software.
          </h2>

          <p className="text-base sm:text-xl text-slate-600 font-sans leading-relaxed">
            Direct access to senior software architects. We map your 3D facial workflows, polarized photo storage, and VIP membership engines in 14 days.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10 pt-2">
          ...
          >
            <span>Schedule 15-Min MedSpa Scope Call</span>
